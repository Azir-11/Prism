...
```ts
import { apcaLc, wcagRatio } from "@simple-prism/core";
...
```ts
import { solveForLc, generateScale } from "@simple-prism/core";
...
```ts
import { pickOnSolid, generateScale, toHex } from "@simple-prism/core";

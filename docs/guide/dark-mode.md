...
console.log(theme.scales.primary.light.steps[50].hex); // 浅色:最亮背景
console.log(theme.scales.primary.dark.steps[50].hex); // 暗色:最暗背景
```
...
```ts
import { apcaLc } from "@simple-prism/core";
